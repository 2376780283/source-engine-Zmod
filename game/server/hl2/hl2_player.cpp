...
ConVar hl2_walkspeed( "hl2_walkspeed", "140" ); // 源参数各加10 对于 走路速度
...
#ifdef HL2MP
	#define	HL2_WALK_SPEED 145
	#define	HL2_NORM_SPEED 185
	#define	HL2_SPRINT_SPEED 315
#else
...
// 视角倾斜 如果需要则value was zero
// ConVar	sv_rollspeed	( "sv_rollspeed", "150", FCVAR_NOTIFY | FCVAR_REPLICATED);
